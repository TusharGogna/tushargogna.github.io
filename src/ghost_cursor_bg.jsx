...
// Force host to always cover the viewport
...
host.style.pointerEvents = 'none';
    ...
    const resize = () => {
      const cssW = Math.max(1, Math.floor(window.innerWidth ?? document.documentElement.clientWidth));
      const cssH = Math.max(1, Math.floor(window.innerHeight ?? document.documentElement.clientHeight));
